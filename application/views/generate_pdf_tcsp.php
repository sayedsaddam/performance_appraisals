	...
	<table border="1" id="skills">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php if($emp->que_nine == '3'){ echo "Yes"; } ?></td>
				<td><?php if($emp->que_nine == '2'){ echo "Yes"; } ?></td>
				<td><?php if($emp->que_nine == '1'){ echo "Yes"; } ?></td>
			</tr>
			<tr>
				<td>10)</td>
				...
				<td><?php if($emp->que_ten == '3'){ echo "Yes"; } ?></td>
				<td><?php if($emp->que_ten == '2'){ echo "Yes"; } ?></td>
				<td><?php if($emp->que_ten == '1'){ echo "Yes"; } ?></td>
			</tr>
		</tbody>
