								...
								<div class="table">
									<table class="table table-condensed">
										...
										<tbody>
											<tr>
												<td>Reliability</td>
												<td align="center"><input type="radio" name="attribute" value="3" <?php if(@$prev_added_tcsps->attrib_1 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute" value="2" <?php if(@$prev_added_tcsps->attrib_1 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute" value="1" <?php if(@$prev_added_tcsps->attrib_1 == '1'){ ?> checked <?php } ?>></td>
											</tr>
											<tr>
												<td>Work independently with minimal supervision</td>
												<td align="center"><input type="radio" name="attribute1" value="3" <?php if(@$prev_added_tcsps->attrib_2 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute1" value="2" <?php if(@$prev_added_tcsps->attrib_2 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute1" value="1" <?php if(@$prev_added_tcsps->attrib_2 == '1'){ ?> checked <?php } ?>></td>
											</tr>
											<tr>
												<td>Punctuality</td>
												<td align="center"><input type="radio" name="attribute2" value="3" <?php if(@$prev_added_tcsps->attrib_3 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute2" value="2" <?php if(@$prev_added_tcsps->attrib_3 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute2" value="1" <?php if(@$prev_added_tcsps->attrib_3 == '1'){ ?> checked <?php } ?>></td>
											</tr>
											<tr>
												<td>Initiative</td>
												<td align="center"><input type="radio" name="attribute3" value="3" <?php if(@$prev_added_tcsps->attrib_4 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute3" value="2" <?php if(@$prev_added_tcsps->attrib_4 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute3" value="1" <?php if(@$prev_added_tcsps->attrib_4 == '1'){ ?> checked <?php } ?>></td>
											</tr>
											<tr>
												<td>Good team player</td>
												<td align="center"><input type="radio" name="attribute4" value="3" <?php if(@$prev_added_tcsps->attrib_5 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute4" value="2" <?php if(@$prev_added_tcsps->attrib_5 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute4" value="1" <?php if(@$prev_added_tcsps->attrib_5 == '1'){ ?> checked <?php } ?>></td>
											</tr>
											<tr>
												<td>Fimiliarity with WHO required procedures</td>
												<td align="center"><input type="radio" name="attribute5" value="3" <?php if(@$prev_added_tcsps->attrib_6 == '3'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute5" value="2" <?php if(@$prev_added_tcsps->attrib_6 == '2'){ ?> checked <?php } ?>></td>
												<td align="center"><input type="radio" name="attribute5" value="1" <?php if(@$prev_added_tcsps->attrib_6 == '1'){ ?> checked <?php } ?>></td>
											</tr>
										</tbody>
									</table>
								</div>
