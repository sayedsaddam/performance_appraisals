					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="<?= base_url('performance_evaluation/save_tcsp_evaluation'); ?>" method="post">
									...
									<table class="table table-condensed">
										...
										<tbody>
											...
											<tr>
												...
												<td align="center"><input type="radio" name="remark8" value="1"></td>
												<td align="center"><input type="radio" name="remark8" value="2"></td>
												<td align="center"><input type="radio" name="remark8" value="3"></td>
											</tr>
											<tr>
												<td>10)</td>
												...
												<td align="center"><input type="radio" name="remark9" value="1"></td>
												<td align="center"><input type="radio" name="remark9" value="2"></td>
												<td align="center"><input type="radio" name="remark9" value="3"></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="inputFormMain">
									<textarea name="others_a" class="form-control" rows="5" placeholder="Start typing here..."></textarea><br>
								</div>
